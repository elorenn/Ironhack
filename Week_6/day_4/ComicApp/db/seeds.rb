...
clark = User.create!(first_name: "Clark", last_name: "Kent", email: "clark@dailyplanet.com", password: "whatever")
tony = User.create!(first_name: "Tony", last_name: "Stark", email: "tony@stark.sexy", password: "whatever")
rick = User.create!(first_name: "Rick", last_name: "Grimes", email: "rick@zombies.co", password: "whatever")
